<template>
    <div class="loginContainer">
        ...
        <div class="login_container btn-lg" @click="mobileLogin">登录</div>
        <div class="login_container" @click="testBtn_click">测试</div>
        <div class="login_container">
            <p>{{test_message}}</p>
        </div>
        <router-link to="/forget" class="login_container" v-if="go_on">go on</router-link>        
        ...
        async testBtn_click() {
            ...
            $.ajax({
                ...
                success: function (req) {
                    //请求成功时处理
                    console.log(req);
                    _this.test_message = req.userName;
                },
                complete: function () {
                    //请求完成的处理
                    // console.log('end');
